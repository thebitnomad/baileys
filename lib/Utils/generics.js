...
const baileysVersion = [2, 3000, 1034945610]
const PLATFORM_MAP = {
    'aix': 'AIX',
    'darwin': 'Mac OS',
    'win32': 'Windows',
...
const fetchLatestBaileysVersion = async (options = {}) => {
    // Tier 1: Fetch latest version directly from web.whatsapp.com/sw.js
    try {
    ...
    // Tier 2: Try wppconnect-team/wa-version GitHub Releases API
    try {
