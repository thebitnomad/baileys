...
const fetchLatestBaileysVersion = async (options = {}) => {
    ...
    try {
        const waVersionUrl = 'https://api.github.com/repos/wppconnect-team/wa-version/releases/latest';
        ...
        if (versionMatch) {
            ...
            console.log('🔄 WA Version (wa-version repo):', version.join('.'));
            return { version, isLatest: true, source: 'wa-version' };
        }
    } catch (e) {
